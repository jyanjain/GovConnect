...
function UploadDocuments() {
  ...
  const proceedButtonStyle = {
    backgroundColor: uploadedFiles.aadhar && uploadedFiles.pan && uploadedFiles.balanceSheet && uploadedFiles.returnFile
      ? "#007bff"
      : "#ccc",
    color: "#fff",
    borderRadius: "8px",
    padding: "10px 20px",
    border: "none",
    cursor: uploadedFiles.aadhar && uploadedFiles.pan && uploadedFiles.balanceSheet && uploadedFiles.returnFile
      ? "pointer"
      : "not-allowed",
    marginTop: "20px",
  };
...
<div>
        ...
        <button style={proceedButtonStyle} disabled={!uploadedFiles.aadhar || !uploadedFiles.pan || !uploadedFiles.balanceSheet || !uploadedFiles.returnFile}>
          Proceed
        </button>
      </div>
    </div>
